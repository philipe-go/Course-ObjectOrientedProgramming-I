...
namespace GeometricShapesFinal
{
    public partial class Form1 : Form
    {
        ...
        public void mRefresh()
        {
            ...
            this.tbDx.Text = "5";
            this.tbDy.Text = "5";
            this.cbBoColor.SelectedIndex = 0;
            this.cbBrColor.SelectedIndex = 0;
        ...
        {
            if ((rbSquare.Checked) || (rbSquare.Checked) || (rbSquare.Checked) || (rbSquare.Checked))
            {
                //SQUARE
                if (rbSquare.Checked)
                {
            ...
            else { MessageBox.Show("You have not selected a Shape to be drawn"); }
        }
